...
<html lang="en">
	...
	<body>
		<%
		System.out.println(request.getAttribute("PollutionData"));
		%>
		<div class="site-content">
			...
			<div class="hero" data-bg-image="pages/Index_Page_Styling/images/banner.png">
				<div class="container">
					<form action="getPollution" method="post" class="find-location">
						...
						<div class="today forecast">
							...
							<div class="w3-container">
							  ...
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="co" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>NO</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="no" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>NO2</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="no2" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>O3</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="o3" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>SO2</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="so2" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>PM2_5</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="pm2" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>PM10</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="pm10" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
							...
							<div class="w3-container">
							  <h3>NH3</h3>
							  <div class="w3-light-grey w3-round-xlarge">
							    <div id="nh3" class="w3-container w3-red w3-round-xlarge" style="height:24px;width:0"></div>
							  </div>
							  <br>
							</div>	
