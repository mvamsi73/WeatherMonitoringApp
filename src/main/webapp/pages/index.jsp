...
<html lang="en">
	...
	<body>
				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item"><a href="/gotosubscribe">Subscribe</a></li>
					...
					<div class="forecast-container">
						...
						<div class="forecast">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day1").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day1").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day1").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
						<div class="forecast">
							<div class="forecast-header">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day2").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day2").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day2").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
						<div class="forecast">
							<div class="forecast-header">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day3").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day3").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day3").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
						<div class="forecast">
							<div class="forecast-header">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day4").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day4").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day4").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
						<div class="forecast">
							<div class="forecast-header">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day5").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day5").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day5").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
						<div class="forecast">
							<div class="forecast-header">
							...
							<div class="forecast-content">
								...
								<div class="degree">${FutureData.getJSONObject("day6").getInt("day") }<sup>o</sup>C</div>
								<small>Min : ${FutureData.getJSONObject("day6").getInt("min") }<sup>o</sup></small>
								<small>Max : ${FutureData.getJSONObject("day6").getInt("max") }<sup>o</sup></small>
							</div>
						</div>
					</div>
				</div>
        ...
        displayDate();
        progress('${100-(AdditionalForecasts.get("FlightDelays").getInt("Value")*10)}',"flight");
        progress('${100-(AdditionalForecasts.get("Jogging").getInt("Value")*10)}',"jog");
        progress('${100-(AdditionalForecasts.get("Bicycling").getInt("Value")*10)}',"bic");
        progress('${100-(AdditionalForecasts.get("BeachAndPool").getInt("Value")*10)}',"beach");
        progress('${100-(AdditionalForecasts.get("Fishing").getInt("Value")*10)}',"fish");
        progress('${100-(AdditionalForecasts.get("Construction").getInt("Value")*10)}',"con");
        progress('${100-(AdditionalForecasts.get("Asthma").getInt("Value")*10)}',"asth");
        progress('${100-(AdditionalForecasts.get("DrivingConditions").getInt("Value")*10)}',"drive");
		</script>
